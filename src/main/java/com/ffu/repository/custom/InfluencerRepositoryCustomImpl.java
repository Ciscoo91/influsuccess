...
public class InfluencerRepositoryCustomImpl extends AbstractDAO implements  InfluencerRepositoryCustom{
    ...
    public Page<Influencer> getInfluencerPageable(InfluencerSearchDTO influencerSearchDTO, Pageable pageable) {
        ...
        influencerCriteriaQuery.select(influencerRoot)
    ...
    private void buildPredicates(List<Predicate> predicates, InfluencerSearchDTO influencerSearchDTO, Root<Influencer> influencerRoot,CriteriaQuery<Influencer> cq,
        ...
        if(influencerSearchDTO.getSocialNetworkName() != null){
            Root<SocialNetwork> socialNetworkRoot = cq.from(SocialNetwork.class);
            this.addPredicate(predicates, socialNetworkRoot.get(SocialNetwork_.NAME), influencerSearchDTO.getSocialNetworkName().toString(), builder);
        }
        ...
        if(influencerSearchDTO.getCampaignCategoryEnum() != null){
            ...
            this.addPredicate(predicates, campaignCategoryRoot.get(CampaignCategory_.NAME), influencerSearchDTO.getCampaignCategoryEnum().toString(), builder);
        }
