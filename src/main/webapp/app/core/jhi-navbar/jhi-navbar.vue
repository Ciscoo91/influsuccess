  ...
  <b-navbar toggleable="md" type="dark" variant="primary" class="jh-navbar">
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item v-if="!authenticated" v-on:click="openLogin()" id="login" active-class="active">
          <!-- <font-awesome-icon icon="sign-in-alt" /> -->
          <span v-text="$t('global.menu.account.login')">Sign in</span>
        </b-nav-item>
        <b-nav-item to="/register" id="register" v-if="!authenticated" active-class="active">
        ...
        >
          <span slot="button-content" class="navbar-dropdown-menu">
            <!-- <font-awesome-icon icon="user" /> -->
            <span class="text-white" v-text="$t('global.menu.account.main')">
              Account
            </span>
          </span>
        ...
        <b-nav-item-dropdown id="languagesnavBarDropdown" right v-if="languages && Object.keys(languages).length > 1">
          <span slot="button-content">
            ...
            <span class="text-white" v-text="$t('global.menu.language')">Language</span>
          </span>
          <b-dropdown-item
