...
<div class="container bootdey flex-grow-1 container-p-y">
    ...
    <div class="media align-items-center py-3 mb-3">
        ...
        <h4 class="font-weight-bold mb-0">{{username}}<span class="text-muted font-weight-normal"></span></h4>
        <a href="/account/settings" class="btn btn-primary btn-sm">Edit</a>
        </div>
    </div>
    ...
    <div class="card mb-4 border-0 shadow-sm">
        ...
        <table class="table table-light table-striped card-table m-0">
            <tbody>
            <tr>
