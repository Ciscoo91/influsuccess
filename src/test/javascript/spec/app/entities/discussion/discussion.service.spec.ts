...
describe('Service Tests', () => {
  describe('Discussion Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Discussion', async () => {
      ...
      it('should not update a Discussion', async () => {
      ...
      it('should return a list of Discussion', async () => {
        const returnedFromService = Object.assign({}, elemDefault);
        const expected = Object.assign({}, returnedFromService);
      ...
      it('should not return a list of Discussion', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Discussion', async () => {
