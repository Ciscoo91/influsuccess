...
public class UserResourceIT {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(hasItems(AuthoritiesConstants.ADVERTISER, AuthoritiesConstants.ADMIN)));
    }
    ...
    public void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.ADVERTISER);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.ADVERTISER);
    ...
    public void testAuthorityEquals() {
        ...
        authorityA.setName(AuthoritiesConstants.ADVERTISER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.ADVERTISER);
        assertThat(authorityA).isEqualTo(authorityB);
